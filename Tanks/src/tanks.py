...
class Game():
	...
	def __init__(self, show=True):
		...
		sprites = pygame.transform.scale(pygame.image.load("../venv/images/sprites.gif"), [192, 224])
		...
		if play_sounds:
			...
			sounds["start"] = pygame.mixer.Sound("../venv/sounds/gamestart.ogg")
			sounds["end"] = pygame.mixer.Sound("../venv/sounds/gameover.ogg")
			sounds["score"] = pygame.mixer.Sound("../venv/sounds/score.ogg")
			sounds["bg"] = pygame.mixer.Sound("../venv/sounds/background.ogg")
			sounds["fire"] = pygame.mixer.Sound("../venv/sounds/fire.ogg")
			sounds["bonus"] = pygame.mixer.Sound("../venv/sounds/bonus.ogg")
			sounds["explosion"] = pygame.mixer.Sound("../venv/sounds/explosion.ogg")
			sounds["brick"] = pygame.mixer.Sound("../venv/sounds/brick.ogg")
			sounds["steel"] = pygame.mixer.Sound("../venv/sounds/steel.ogg")
